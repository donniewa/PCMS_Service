...
class PCMS_Service_Pcms
{
    ...
    public function __construct($siteId, $cacheModelObj = null, $cacheClientObj = null)
    {
        ...
        try {
            $this->_client  =   new PCMS_Service_Pcms_Client_Oauth($this->_config, $this->_siteId, $cacheClientObj);
        } catch (DomainException $e) {
            echo $e->getMessage();
        }

        $this->_model   =   new PCMS_Service_Pcms_Model_Rest($this->_config, $this->_client, $this->_siteId);
